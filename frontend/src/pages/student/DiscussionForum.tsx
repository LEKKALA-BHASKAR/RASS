...
const DiscussionForum: React.FC<DiscussionForumProps> = ({ courseId }) => {
  ...
  const togglePost = (postId: string) => {
    ...
    newExpanded.has(postId) ? newExpanded.delete(postId) : newExpanded.add(postId);
  ...
  const handleReply = async (postId: string, replyContent: string) => {
    ...
    try {
      ...
      finalCourseId ? fetchCoursePosts(finalCourseId) : fetchAllPosts();
      setReplyingTo(null);
    } catch (err) {
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white">
        ...
        <p className="mt-2 text-blue-100">
          {finalCourseId
            ? `Course discussions for ${posts[0]?.course?.title || "this course"}`
            : "All discussions from your enrolled courses"}
        </p>
      </div>
      ...
      {finalCourseId && (
        ...
        >
          ...
          <form onSubmit={handleCreatePost} id="new-post-form">
            <input
              type="text"
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg font-medium hover:shadow-md transition-all disabled:opacity-50"
            >
              {creatingPost ? "Posting..." : "Post Discussion"}
            </button>
          </form>
        </motion.div>
      )}
                ...
                <div className="border-t border-gray-100 p-6 bg-gray-50">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    <textarea
                      ...
                      value={
                        replyingTo?.postId === post._id ? replyingTo.reply : ""
                      }
                      onChange={(e) =>
                        setReplyingTo({ postId: post._id, reply: e.target.value })
                      }
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        disabled={
                          !(replyingTo?.postId === post._id && replyingTo.reply.trim())
                        }
