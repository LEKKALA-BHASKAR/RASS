...
import { Users, BookOpen, TrendingUp, DollarSign, UserPlus, Settings, ChevronRight, Eye, Search, Filter, MoreHorizontal, Calendar, ArrowUpRight, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {['overview', 'users', 'courses', 'reports', 'settings'].map((tab) => (
              <button
                key={tab}
      ...
      <div className="space-y-4">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow text-left group">
              <div className="flex items-center mb-3">
                <div className="bg-indigo-100 p-2 rounded-lg group-hover:bg-indigo-200 transition-colors">
                  <UserPlus className="h-5 w-5 text-indigo-600" />
                </div>
                <h3
  className="text-md font-semibold text-gray-900 ml-3 cursor-pointer"
  onClick={(e) => {
    e.stopPropagation();
