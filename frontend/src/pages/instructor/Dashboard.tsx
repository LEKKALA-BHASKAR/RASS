    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600">Track courses, students, and activity.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card p-6">
          <div className="flex justify-between mb-4">
            ...
            <Link
              to="/instructor/courses?tab=assignments"
              ...
              {recentSubmissions.map((sub, idx) => (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        `/instructor/courses?course=${sub.courseId}&tab=assignments`
                      )
                    }
                  >
                    Grade
          ...
          {upcomingSessions.length === 0 ? (
            ...
            <ul className="space-y-3">
              {upcomingSessions.map((s) => (
                <li key={s._id} className="p-3 border rounded-lg flex justify-between">
                  <div>
