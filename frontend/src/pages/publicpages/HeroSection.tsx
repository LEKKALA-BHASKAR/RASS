...
export function HeroCarousel() {
  ...
  return (
    <section className="relative h-[85vh] w-full overflow-hidden pt-0 mt-0">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Main Content */}
          <div className="relative h-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 pt-0 mt-0">
            {/* Left Content */}
            <div className="flex items-center justify-center px-4 py-2 lg:px-6 lg:py-4 z-10 order-2 lg:order-1">
              <div className="max-w-2xl text-center lg:text-left">
                <motion.h1
                  initial={{ y: 40, opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 0.3 }}
                  className="text-4xl sm:text-5xl lg:text-6xl xl:text-5xl font-bold text-white leading-tight pb-2"
                >
                ...
                <motion.p
                  ...
                  className="text-xl sm:text-2xl text-white/80 leading-relaxed mb-6 font-light"
                >
                    ...
                    return (
                      <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                        <div className="flex flex-col items-center justify-center">
                          <div className="bg-gradient-to-br from-white/20 to-white/5 p-3 rounded-xl mb-3">
            ...
            {/* Right Image */}
            <div className="flex items-center justify-center p-3 lg:p-4 order-1 lg:order-2 relative">
              <motion.div
              ...
              >
                ...
                <div className="relative rounded-3xl overflow-hidden">
                  ...
                  <motion.div
                    ...
                    className={`absolute top-6 right-6 ${currentAccent.primary} ${currentAccent.glow} text-white p-3 rounded-2xl backdrop-blur-sm border border-white/20`}
                  >
